...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 888.0, 437.0, 163.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1179.0, 434.0, 163.0, 22.0 ],
					"text" : "combine Q 1 @triggers 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 888.0, 478.0, 111.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1179.0, 475.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 996.0, 397.5, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1287.0, 394.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1032.0, 397.5, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1323.0, 394.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1032.0, 354.0, 69.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1323.0, 351.0, 69.0, 22.0 ],
					"text" : "route /atem"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1032.0, 310.0, 104.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1323.0, 307.0, 104.0, 22.0 ],
					"text" : "udpreceive 22222"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.5, 268.0, 71.0, 22.0 ],
					"text" : "s _dictview"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 134.0, 457.0, 89.0, 22.0 ],
					"text" : "prepend texton"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 52.0, 513.0, 75.0, 48.0 ],
					"rounded" : 48.0,
					"text" : "Black",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 52.0, 414.0, 171.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 77.0, 310.0, 150.0, 47.0 ],
					"text" : "black, face, C1, C2, Cam1, Cam1-lut, Cam2, Cam2-lut"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 150.75, 163.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 150.75, 231.5, 89.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 169.25, 196.5, 95.0, 22.0 ],
...
,
					"patching_rect" : [ 10.0, 13.0, 87.0, 29.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 296.0, 12.0, 71.0, 22.0 ],
									"text" : "r _dictview"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 236.0, 16.0, 33.0, 22.0 ],
									"text" : "front"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 98.0, 18.0, 100.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 6.0, 43.0, 613.0, 790.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 0.0, 0.0, 613.0, 790.0 ]
								}
...
,
					"patching_rect" : [ 10.0, 196.5, 94.0, 29.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 119.25, 90.0, 71.0, 22.0 ],
					"text" : "s _udpsend"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "dictionary", "", "", "" ],
					"patching_rect" : [ 10.0, 163.0, 57.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 139.75, 46.0, 104.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1091.75, 242.0, 104.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 50.0, 99.0, 22.0 ],
					"text" : "m-e.model /atem"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 119.25, 9.0, 173.0, 22.0 ],
